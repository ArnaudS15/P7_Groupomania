    ...
    <section>
        <article>
            <div class="option" v-if="user.id_user == userId || moderator">
                <router-link v-if="post.User!=null && post.User.id_user == userId" v-bind:to="`/post/modify/${post.id_post}`" class="btn-modify">Éditer</router-link>
                <button class="btn-delpost" v-if="post.User!=null && post.User.id_user == userId" v-on:click="modal=true">Supprimer</button>
            ...
            <div v-if="post.image_url" class="article__img">
                <img v-bind:src="post.image_url" v-bind:alt="post.title"> 
            </div>
            
            <likedislikecomment v-bind:id_post="id_post" v-bind:postcom="true" v-bind:moderator="moderator"></likedislikecomment>  
        </article>

        <router-link v-bind:to="`/`" class="btn_return">Retour aux posts</router-link>
        <modaldeletepost v-if="modal" v-on:delete="deletePost(post.id_post)" v-on:close="modal=false"></modaldeletepost>
    </section>
</template>
...
import LikeDislikeComment from './LikeDislikeComment.vue';
